defmodule UniCanvasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UniCanvasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UniCanvasWeb.Gettext, "errors", msg, opts)
    end
  end
